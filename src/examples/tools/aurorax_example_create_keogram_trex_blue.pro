...
pro aurorax_example_create_keogram_trex_blue
  ; --------------------------------
  ; Creating a TREx Blueline Keogram
  ; --------------------------------
  ;
  ...
  ;
  ; Below, we'll work through the creation of a 1 hour keogram created from TREx-Blueline raw data.
  ;

  ; First, download and read an hour of TREx Blueline data
  d = aurorax_ucalgary_download('TREX_BLUE_RAW', '2023-02-24T06:00:00', '2023-02-24T06:59:59', site_uid = 'rabb')
  ...
  ; Scale the image data as desired
  img = bytscl(img, min=500, max=5000)
  ...
  d = aurorax_ucalgary_download_best_skymap('TREX_BLUE_SKYMAP_IDLSAV', 'rabb', '2023-02-24T06:00:00')
  ...
  p1 = aurorax_keogram_plot(keo, title = 'Geographic', /geo, location = [0, 0], dimensions = [800, 400], colortable = 1)
  p2 = aurorax_keogram_plot(keo, title = 'Elevation', /elev, location = [800, 0], dimensions = [800, 400], colortable = 1)
  p3 = aurorax_keogram_plot(keo, title = 'Geomagnetic (AACGM)', /mag, location = [0, 450], dimensions = [800, 400], colortable = 1)
  ...
  ; Download and read some more TREx Blueline image data
  d = aurorax_ucalgary_download('TREX_BLUE_RAW', '2022-04-04T09:00:00', '2022-04-04T09:59:59', site_uid = 'gill')
  image_data = aurorax_ucalgary_read(d.dataset, d.filenames)
  img = image_data.data
  time_stamp = image_data.timestamp
  ...
  p4 = aurorax_keogram_plot(keo, title = 'Keogram with Missing Data', location = [800, 450], dimensions = [800, 400], colortable = 1)
