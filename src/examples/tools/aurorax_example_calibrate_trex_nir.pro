...
pro aurorax_example_calibrate_trex_nir
  ; --------------------
  ; Calibrating TREx NIR
  ; --------------------
  ;
  ; When working with narrow band image data such as TREx NIR and you'd like to convert the image to physical
  ...
  ; TREx NIR, files can be found at the below data tree, or you can use the tooling to download them.
  ;
  ;   https://data.phys.ucalgary.ca/sort_by_project/TREx/NIR/calibration/
  ;
