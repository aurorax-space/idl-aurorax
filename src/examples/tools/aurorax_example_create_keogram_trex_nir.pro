...
pro aurorax_example_create_keogram_trex_nir
  ; ---------------------------
  ; Creating a TREx NIR Keogram
  ; ---------------------------
  ;
  ...
  ;
  ; Below, we'll work through the creation of a 1 hour keogram created from TREx-NIR raw data.
  ;

  ; First, download and read an hour of TREx NIR data
  d = aurorax_ucalgary_download('TREX_NIR_RAW', '2023-02-24T06:00:00', '2023-02-24T06:59:59', site_uid = 'rabb')
  ...
  d = aurorax_ucalgary_download_best_skymap('TREX_NIR_SKYMAP_IDLSAV', 'rabb', '2023-02-24T06:00:00')
  ...
  ; Download and read some more TREx NIR image data
  d = aurorax_ucalgary_download('TREX_NIR_RAW', '2022-03-07T02:00:00', '2022-03-07T02:59:59', site_uid = 'pina')
  image_data = aurorax_ucalgary_read(d.dataset, d.filenames)
  img = image_data.data
  time_stamp = image_data.timestamp
