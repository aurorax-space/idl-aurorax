...
pro aurorax_example_create_keogram_themis
  ...
  p2 = aurorax_keogram_plot(keo, title = 'Elevation', /elev, location = [0, 420], dimensions = [1000, 400], y_tick_interval = 25)
  ...
  p3 = aurorax_keogram_plot(keo, title = 'Keogram with Missing Data', location = [850, 0], dimensions = [1000, 400], colortable = 0)
