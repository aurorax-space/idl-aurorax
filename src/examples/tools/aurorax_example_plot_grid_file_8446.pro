...
pro aurorax_example_plot_grid_file_8446
  ...
  rgba_grid = aurorax_prep_grid_image(grid, fill_val, scale = rayleighs_scale, color_table = 7)

  ; Create a map
  map_limit = [35, -140, 70, -60]
  ...
  ; Add some labels
  t = text(0.215, 0.875, 'TREx NIR - Calibrated 844.6 nm', font_size = 20, color = 'white', font_style = 1)
  t = text(0.215, 0.105, timestamp, font_size = 20, color = 'white', font_style = 1)
  cbar = colorbar(range = rayleighs_scale, orientation = 1, position = [0.73, 0.1, 0.74, 0.9], textpos = 1, tickdir = 1, font_style = 1, font_size = 10, $
    border_on = 1, color = 'white', rgb_table = 7, tickname = ['0 kR', '1 kR', '2 kR', '3 kR', '4 kR', '5+ kR'])
end
