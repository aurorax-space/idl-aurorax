...
pro aurorax_example_search_ephemeris_ml
  ...
  ; to only retrieve records which the 'calgary_apa_ml_v1' ML dataset
  ...
  ; Let's create a new search fo a shorter time range. Let's instead search for data from
  ; the same site, but filter based on clouds. We will search for data that was classified
  ; as not cloudy, with a confidence of at least 95%
  start_search_date = '2008-01-01T00:00'
  ...
  expression_2 = aurorax_create_metadata_filter_expression('calgary_cloud_ml_v1_confidence', 95, /operator_ge)
  expressions = list(expression_1, expression_2)
  metadata_filters = aurorax_create_metadata_filter(expressions, /operator_and)
  ...
  ; discrete or diffuse aurora, using the OATH ML model results.
  start_search_date = '2008-01-01T00:00'
  end_search_date = '2008-01-07T23:59'
