...
;       mosaic_dt : out, optional
;         a named variable that, if supplied, will contain the timestamp that the plotted
;         mosaic corresponds to. Useful for being certain of timestamps when plotting multiple
;         instruments with different cadences on the same mosaic (e.g. spectrograph + ASI)
;
; :Examples:
